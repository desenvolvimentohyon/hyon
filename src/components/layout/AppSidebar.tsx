import { LayoutDashboard, ListTodo, Users, Wrench, Settings } from "lucide-react";
  ...
  return (
    <Sidebar collapsible="icon">
        ...
        <div className="flex items-center gap-2">
          ...
          {!collapsed && (
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-sidebar-foreground/50">Gerenciador de Tarefas</span>
            </div>
          )}
        </div>
      </SidebarHeader>
      ...
      <SidebarFooter className="p-4">
        {!collapsed && (
          <p className="text-[10px] text-sidebar-foreground/40 text-center">v1.0 — UI Only</p>
        )}
      </SidebarFooter>
    </Sidebar>
  );
