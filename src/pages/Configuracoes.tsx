...
export default function Configuracoes() {
  ...
  const saveModulo = () => { if (!fModulo.nome.trim()) { sonnerToast.error("Nome obrigatório"); return; } modal?.editing ? updateModulo(modal.editing, fModulo) : addModulo(fModulo); setModal(null); sonnerToast.success("Módulo salvo!"); };
